...
| Apache Iceberg | 1.10.1 | `iceberg-spark-runtime-3.5_2.12:1.10.1` | [Iceberg Spark getting started](https://iceberg.apache.org/docs/1.8.0/docs/spark-getting-started/) | Runtime oficial para Spark 3.5/Scala 2.12; AWS bundle adiciona suporte S3. |
...
- Spark 3.5 requer Java 17 como minimo suportado; a imagem fixa `java17`.
